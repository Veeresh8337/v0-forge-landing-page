...
export const metadata: Metadata = {
  title: 'Forge - Connect Student Developers with Opportunities',
  description: 'Forge matches exceptional student developers with premium freelance opportunities. Join top talent in building the future.',
  generator: 'v0.app',
  icons: {
    icon: [
      {
